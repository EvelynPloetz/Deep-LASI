...
On the *Channel Position* pop-up window, you can see a preview of the loaded ZMW image. Like the case on :numref:`map image load`, we clicked on *Full* to load the whole field of view, and then clicked on *OK*. 
