...
On the *Channel Position* pop-up window, you can see a preview of the loaded ZMW image. Like the case on :numref:`map image preview`, we clicked on *Full* to load the whole field of view, and then clicked on *OK*. 

.. figure:: ./../../figures/examples/PA2_map_image_loading.png
   :width: 500
   :alt: map image load
   :align: center
   :name: map image preview
